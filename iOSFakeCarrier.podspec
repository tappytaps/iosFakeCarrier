#
#  Be sure to run `pod spec lint iOSFakeCarrier.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Jindrich Sarson"
  # s.authors            = { "Jindrich Sarson" => "jindra@tappytaps.com" }
  # s.social_media_url   = "http://twitter.com/Jindrich Sarson"
